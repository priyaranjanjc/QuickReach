...
public class MainFragment extends Fragment {
    ...
    //  Fragment to display list of applications present in the device.
    //  User can toggle his selection in this fragment.
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            toggle.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    Set<String> appList = pref.getStringSet("apps", null);
                    if (appList == null)                                            //User selection is stored
                                                                // in sharedPrefernces.
                    ...
                    if (isChecked) {
                        ...
                        SharedPreferences.Editor edit = pref.edit();
                        appList.remove((String) buttonView.getTag());
                        edit.clear();
                        edit.putStringSet("apps", appList);
                        edit.commit();
    ...
    public void onCategoryChanged(String catName) {
        pref = getActivity().getSharedPreferences(catName.toLowerCase(), getActivity().MODE_PRIVATE);
